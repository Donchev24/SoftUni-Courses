...
namespace ArtCollective.Data
{
    ...
    {
        private const string ConnectionString = @"Server=.;Database=ArtCollective;Trusted_Connection=True;";
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(ag => new { ag.ArtistId, ag.GroupId });
            });

            modelBuilder.Entity<Collaboration>(entity =>
            {
                entity.HasKey(col => new { col.ArtistOneId, col.ArtistTwoId });
            });
    
            modelBuilder.Entity<Collaboration>()
                .HasOne(c => c.ArtistOne)
                .WithMany(a => a.CollaborationsAsArtistOne)
                .HasForeignKey(c => c.ArtistOneId)
                .OnDelete(DeleteBehavior.Restrict);
    
            modelBuilder.Entity<Collaboration>()
                .HasOne(c => c.ArtistTwo)
                .WithMany(a => a.CollaborationsAsArtistTwo)
